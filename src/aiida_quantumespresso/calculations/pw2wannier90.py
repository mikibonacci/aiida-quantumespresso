...
class Pw2wannier90Calculation(NamelistsCalculation):
    ...
    _EXTERNAL_PROJECTORS_SUBFOLDER = './external_projectors/'
    ...
    def define(cls, spec):
        ...
        spec.input(
            ...
            required=False,
            help='Path to the external projectors.'
        )
        spec.input(
            'external_projectors_list',
            valid_type=Dict,
            required=False,
            help='Dict of projectors with kind name and element symbol.'
        )
    ...
    def prepare_for_submission(self, folder):
        ...
        if 'external_projectors_list' in self.inputs and 'external_projectors_path' in self.inputs:
            ext_proj_path = self.inputs.external_projectors_path
